...
return ag end function a.S()--这里sjdhshd都不带回的就是感受到还是我就呵呵呵伤感说说嗯设备不好安静啊
return{
Elements={
Paragraph=a.load'A',
Button=a.load'B',
...
function a.Y()
    ...
    local aa = a.load'b'  -- 注意：这里应该是 b 而不是 c，b 是核心模块
    local ae = aa.New
    local af = aa.Tween

    function SectionModule.New(aj, ak)
        local al = {
            __type = "Section",
            Title = ak.Title or "Section",
            Desc = ak.Desc,
...
function a.C()--zzzzzzzzzzzzzzzzzzzzzzz
local aa=a.load'c'
local ab=aa.New
